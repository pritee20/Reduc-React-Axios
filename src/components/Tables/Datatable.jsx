        ...
        return (
            <ContentWrapper>
                ...
                <Grid fluid>
                    ...
                    <Row>
                        <Col lg={ 12 }>
                            <Panel header="Data Tables | Column Ordering">
                                <Table id="datatable2" responsive striped hover>
                                    <thead>
                                        <tr>
                                            <th>Rendering engine</th>
                                            <th>Browser</th>
                    ...
                    <Row>
                        <Col lg={ 12 }>
                            <Panel header="Data Tables | Column Visibility">
                                <Table id="datatable3" responsive striped hover>
                                    <thead>
                                        <tr>
                                            <th>Rendering engine</th>
                                            <th>Browser</th>
                    ...
                    <Row>
                        <Col lg={ 12 }>
                            <Panel header="Data Tables | Ajax Content">
                                <Table id="datatable4" responsive striped>
                                    <thead>
                                        <tr>
