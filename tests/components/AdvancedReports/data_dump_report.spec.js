...
import 
    React from 'react';
import DataDumpReport from '../../../src/advanceReports/components/DataDumpReport';
...
*/
describe('Data Dump Report', function () {
    ...
    it('render Data Dump Report component', function () {
        const wrapper = mount(
        ...
        const reportWrapper = wrapper.find(DataDumpReport);
