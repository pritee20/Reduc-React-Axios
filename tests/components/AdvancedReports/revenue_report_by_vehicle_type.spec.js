...
import RevenueReportByVehicleType from '../../../src/advanceReports/components/RevenueReportByVehicleType';
 ...
 */
describe('Revenue Report By Vehicle Type', function () {
    ...
    it('render Revenue Report By Time Duration component', function () {
        ...
        const reportWrapper = wrapper.find(RevenueReportByVehicleType);

        expect(reportWrapper.props().dateRange).to.exist;
